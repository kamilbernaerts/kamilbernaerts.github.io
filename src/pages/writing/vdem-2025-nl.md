...
<figure>
  <p class="fig-label">Figuur 6</p>
  <img src="/images/vdem-6.png" alt="Wereldkaart van landen in een autocratiseringsperiode (V-Dem)." />
  <figcaption>Wereldkaart van landen die zich momenteel in een autocratiseringsperiode bevinden (V-Dem).</figcaption>
</figure>

> In één enkel jaar daalde de VS van de 20ste naar de 51ste plaats in V-Dems mondiale democratieranglijst, waarbij de score op de Liberale Democratie-index daalde van 0,79 naar 0,57 — de grootste daling in één jaar in de Amerikaanse geschiedenis teruggaand tot 1789.

<figure>
  <p class="fig-label">Figuur 7</p>
  <img src="/images/vdem-7.png" alt="Wereldkaart van landen in een democratiseringsperiode (V-Dem)." />
  <figcaption>Wereldkaart van landen die zich momenteel in een democratiseringsperiode bevinden (V-Dem).</figcaption>
</figure>
