...
Despite the grim overall picture, there is one possible reason for cautious optimism: we may be at the crest of the wave. V-Dem itself notes a modest decline in the number of simultaneously autocratising countries — from a historical peak of 50 in 2021 to 44 in 2025 — and raises the question of whether the third wave may be cresting.

Several important caveats are in order before drawing that conclusion, however. First, 10 new autocratisers were identified in 2025 while 11 episodes ended — but several of those endings reflect not democratic recovery, but the stabilisation of fully entrenched autocratic regimes, as in Russia and Turkey. Second, V-Dem's methodology is deliberately conservative and back-dates episode starts; the final 2025 count may yet rise as more data becomes available. Third, and most critically, the accumulated scale of democratic losses is without historical precedent. A [recent paper by Staffan Lindberg](https://www.tandfonline.com/doi/full/10.1080/13510347.2026.2615134), chief editor of the report, demonstrates that the current wave of autocratisation is worse than the 1930s in terms of length, scope, and magnitude. The share of the world's population living in autocratising countries (41%) has never been higher in recorded history. Even if the number of autocratising countries were to stabilise, the accumulated damage of decades of democratic erosion would remain. The wave may or may not be cresting — but we are, without question, still bearing the full force of the tsunami.
...
The autocratising tsunami has, moreover, already made landfall closer to home. The United States, the United Kingdom, and Italy — long-standing members and in some ways founders of the Western democratic tradition — are now classified as countries in active autocratisation episodes. Liberal institutions everywhere are under pressure.

Above all, this report is a reminder that democracy is fragile and should never be taken for granted. It is a wake-up call to defend democracy abroad — but also here at home. Belgium may still be a liberal democracy, but that is a distinction worth protecting, not assuming.
