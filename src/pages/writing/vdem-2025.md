...
This specific wave of autocratisation is not only unprecedently widespread and intense, it is also unique in kind. First, this wave is very volatile: 62 countries are undergoing significant regime change (up from 44 in 2015). Second, the accumulated scale of democratic losses is without historical precedent. A [recent paper by Staffan Lindberg](https://www.tandfonline.com/doi/full/10.1080/13510347.2026.2615134), chief editor of the report, demonstrates that the current wave of autocratisation is worse than the 1930s in terms of length, scope, and magnitude. The share of the world's population living in autocratising countries (41%) has never been higher in recorded history. 
